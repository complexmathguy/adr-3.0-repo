...
echo 'add a remote pseudo for the adr-3.0-repo repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/adr-3.0-repo
